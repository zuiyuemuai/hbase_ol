...
public class HBaseConnector
{
	...
	public HBaseConnector(String zookeeper_quorum, String zookerrper_clientPort)
	{
		configuration.set("hbase.zookeeper.quorum", zookeeper_quorum);
		configuration.set("hbase.zookeeper.property.clientPort", zookerrper_clientPort);
	}
	...
	public void addRecord(String tableName, Put put)
	{
		try
		{
	...
	public void addRecord(String tableName, String rowKey, String family, String qualifier, String value)
	{
		try
		{
			...
			hTable.put(put);
			logger.debug("insert recored " + rowKey + " to table " + tableName + " successfully");
	...
	public StringBuffer scan(String tableName, Filter filter)
	{
		StringBuffer buffer = new StringBuffer();
		try
		{
...
//					logger.debug(new String(keyValue.getValue()));
	...
	public StringBuffer scan(String tableName)
	{
		return scan(tableName, null);
	}
	
	public HTableDescriptor[] getAllTableNameList()
	{
		try
		{
